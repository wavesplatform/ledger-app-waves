...
void waves_message_sign(const cx_ecfp_private_key_t *private_key, const ed25519_public_key public_key, const unsigned char *tx_sha512_hash, ed25519_signature signature) {
    // ed25519 signature with the sha512 hashing
    cx_eddsa_sign(private_key, CX_RND_RFC6979 | CX_LAST, CX_SHA512, tx_sha512_hash, 64, NULL, 0, signature, 64, NULL);
