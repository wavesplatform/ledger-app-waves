...
#define PB_GEN_FIELD_INFO_ASSERT_AUTO(structname, atype, htype, ltype,         \
                                      fieldname, tag)                          \
  PB_GEN_FIELD_INFO_ASSERT_AUTO2(PB_FIELDINFO_WIDTH_AUTO(atype, htype, ltype), \
                                 structname, atype, htype, ltype, fieldname,   \
                                 tag)

#define PB_GEN_FIELD_INFO_ASSERT_AUTO2(width, structname, atype, htype, ltype, \
                                       fieldname, tag)                         \
  PB_GEN_FIELD_INFO_ASSERT(width, structname, atype, htype, ltype, fieldname,  \
                           tag)
...
#define PB_SIZE_OFFSET_CALLBACK(htype, structname, fieldname)                  \
  PB_SIZE_OFFSET_CB_##htype(structname, fieldname)
...
#define PB_SIZE_OFFSET_CB_ONEOF(structname, fieldname)                         \
  PB_SIZE_OFFSET_ONEOF(structname, fieldname)
...
#define PB_DATA_SIZE_CALLBACK(htype, structname, fieldname)                    \
  PB_DATA_SIZE_CB_##htype(structname, fieldname)
...
#define PB_DATA_SIZE_PTR_FIXARRAY(structname, fieldname)                       \
  pb_membersize(structname, fieldname[0])
#define PB_DATA_SIZE_CB_REQUIRED(structname, fieldname)                        \
  pb_membersize(structname, fieldname)
#define PB_DATA_SIZE_CB_SINGULAR(structname, fieldname)                        \
  pb_membersize(structname, fieldname)
#define PB_DATA_SIZE_CB_OPTIONAL(structname, fieldname)                        \
  pb_membersize(structname, fieldname)
#define PB_DATA_SIZE_CB_ONEOF(structname, fieldname)                           \
  pb_membersize(structname, PB_ONEOF_NAME(FULL, fieldname))
#define PB_DATA_SIZE_CB_REPEATED(structname, fieldname)                        \
  pb_membersize(structname, fieldname)
#define PB_DATA_SIZE_CB_FIXARRAY(structname, fieldname)                        \
  pb_membersize(structname, fieldname)
...
#define PB_SUBMSG_INFO_ONEOF3(ltype, structname, unionname, membername)        \
  PB_SUBMSG_INFO_##ltype(structname##_##unionname##_##membername##_MSGTYPE)
