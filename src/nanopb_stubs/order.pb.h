...
#define _waves_Order_Side_ARRAYSIZE                                            \
  ((waves_Order_Side)(waves_Order_Side_SELL + 1))

/* Initializer values for message structs */
#define waves_AssetPair_init_default                                           \
  {                                                                            \
    {{NULL}, NULL}, { {NULL}, NULL }                                           \
  }
#define waves_Order_init_default                                               \
  {                                                                            \
    0, {{NULL}, NULL}, {{NULL}, NULL}, false, waves_AssetPair_init_default,    \
        _waves_Order_Side_MIN, 0, 0, 0, 0, false, waves_Amount_init_default, 0 \
  }
#define waves_AssetPair_init_zero                                              \
  {                                                                            \
    {{NULL}, NULL}, { {NULL}, NULL }                                           \
  }
#define waves_Order_init_zero                                                  \
  {                                                                            \
    0, {{NULL}, NULL}, {{NULL}, NULL}, false, waves_AssetPair_init_zero,       \
        _waves_Order_Side_MIN, 0, 0, 0, 0, false, waves_Amount_init_zero, 0    \
  }
