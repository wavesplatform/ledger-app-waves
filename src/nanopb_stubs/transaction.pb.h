...
#define waves_SignedTransaction_init_default                                   \
  {                                                                            \
    false, waves_Transaction_init_default, { {NULL}, NULL }                    \
  }
#define waves_Transaction_init_default                                         \
  {                                                                            \
    0, {{NULL}, NULL}, {{NULL}, NULL}, false, waves_Amount_init_default, 0, 0, \
        {{NULL}, NULL}, 0, {                                                   \
      waves_GenesisTransactionData_init_default                                \
    }                                                                          \
  }
#define waves_GenesisTransactionData_init_default                              \
  { {{NULL}, NULL}, 0 }
#define waves_PaymentTransactionData_init_default                              \
  { {{NULL}, NULL}, 0 }
#define waves_TransferTransactionData_init_default                             \
  {                                                                            \
    false, waves_Recipient_init_default, false, waves_Amount_init_default, {   \
      {NULL}, NULL                                                             \
    }                                                                          \
  }
#define waves_CreateAliasTransactionData_init_default                          \
  {                                                                            \
    { {NULL}, NULL }                                                           \
  }
#define waves_DataTransactionData_init_default                                 \
  { 0 }
#define waves_DataTransactionData_DataEntry_init_default                       \
  { 0 }
#define waves_MassTransferTransactionData_init_default                         \
  {                                                                            \
    {{NULL}, NULL}, { {NULL}, NULL }                                           \
  }
#define waves_LeaseTransactionData_init_default                                \
  { false, waves_Recipient_init_default, 0 }
#define waves_LeaseCancelTransactionData_init_default                          \
  {                                                                            \
    { {NULL}, NULL }                                                           \
  }
#define waves_BurnTransactionData_init_default                                 \
  { false, waves_Amount_init_default }
#define waves_IssueTransactionData_init_default                                \
  { {{NULL}, NULL}, {{NULL}, NULL}, 0, 0, 0 }
#define waves_ReissueTransactionData_init_default                              \
  { false, waves_Amount_init_default, 0 }
#define waves_SetAssetScriptTransactionData_init_default                       \
  {                                                                            \
    { {NULL}, NULL }                                                           \
  }
#define waves_SetScriptTransactionData_init_default                            \
  { 0 }
#define waves_ExchangeTransactionData_init_default                             \
  {                                                                            \
    0, 0, 0, 0, { {NULL}, NULL }                                               \
  }
#define waves_SponsorFeeTransactionData_init_default                           \
  { false, waves_Amount_init_default }
#define waves_InvokeScriptTransactionData_init_default                         \
  {                                                                            \
    false, waves_Recipient_init_default, {{NULL}, NULL}, 0, {                  \
      waves_Amount_init_default, waves_Amount_init_default                     \
    }                                                                          \
  }
#define waves_UpdateAssetInfoTransactionData_init_default                      \
  {                                                                            \
    {{NULL}, NULL}, {{NULL}, NULL}, { {NULL}, NULL }                           \
  }
#define waves_SignedTransaction_init_zero                                      \
  {                                                                            \
    false, waves_Transaction_init_zero, { {NULL}, NULL }                       \
  }
#define waves_Transaction_init_zero                                            \
  {                                                                            \
    0, {{NULL}, NULL}, {{NULL}, NULL}, false, waves_Amount_init_zero, 0, 0,    \
        {{NULL}, NULL}, 0, {                                                   \
      waves_GenesisTransactionData_init_zero                                   \
    }                                                                          \
  }
#define waves_GenesisTransactionData_init_zero                                 \
  { {{NULL}, NULL}, 0 }
#define waves_PaymentTransactionData_init_zero                                 \
  { {{NULL}, NULL}, 0 }
#define waves_TransferTransactionData_init_zero                                \
  {                                                                            \
    false, waves_Recipient_init_zero, false, waves_Amount_init_zero, {         \
      {NULL}, NULL                                                             \
    }                                                                          \
  }
#define waves_CreateAliasTransactionData_init_zero                             \
  {                                                                            \
    { {NULL}, NULL }                                                           \
  }
#define waves_DataTransactionData_init_zero                                    \
  { 0 }
#define waves_DataTransactionData_DataEntry_init_zero                          \
  { 0 }
#define waves_MassTransferTransactionData_init_zero                            \
  {                                                                            \
    {{NULL}, NULL}, { {NULL}, NULL }                                           \
  }
#define waves_LeaseTransactionData_init_zero                                   \
  { false, waves_Recipient_init_zero, 0 }
#define waves_LeaseCancelTransactionData_init_zero                             \
  {                                                                            \
    { {NULL}, NULL }                                                           \
  }
#define waves_BurnTransactionData_init_zero                                    \
  { false, waves_Amount_init_zero }
#define waves_IssueTransactionData_init_zero                                   \
  { {{NULL}, NULL}, {{NULL}, NULL}, 0, 0, 0 }
#define waves_ReissueTransactionData_init_zero                                 \
  { false, waves_Amount_init_zero, 0 }
#define waves_SetAssetScriptTransactionData_init_zero                          \
  {                                                                            \
    { {NULL}, NULL }                                                           \
  }
#define waves_SetScriptTransactionData_init_zero                               \
  { 0 }
#define waves_ExchangeTransactionData_init_zero                                \
  {                                                                            \
    0, 0, 0, 0, { {NULL}, NULL }                                               \
  }
#define waves_SponsorFeeTransactionData_init_zero                              \
  { false, waves_Amount_init_zero }
#define waves_InvokeScriptTransactionData_init_zero                            \
  {                                                                            \
    false, waves_Recipient_init_zero, {{NULL}, NULL}, 0, {                     \
      waves_Amount_init_zero, waves_Amount_init_zero                           \
    }                                                                          \
  }
#define waves_UpdateAssetInfoTransactionData_init_zero                         \
  {                                                                            \
    {{NULL}, NULL}, {{NULL}, NULL}, { {NULL}, NULL }                           \
  }
...
#define waves_Transaction_FIELDLIST(X, a)                                      \
  ...
  X(a, STATIC, ONEOF, MSG_W_CB, (data, mass_transfer, data.mass_transfer),     \
    111)                                                                       \
  X(a, STATIC, ONEOF, MSG_W_CB,                                                \
    (data, data_transaction, data.data_transaction), 112)                      \
  ...
  X(a, STATIC, ONEOF, MSG_W_CB,                                                \
    (data, set_asset_script, data.set_asset_script), 115)                      \
  X(a, STATIC, ONEOF, MSG_W_CB, (data, invoke_script, data.invoke_script),     \
    116)                                                                       \
  X(a, STATIC, ONEOF, MSG_W_CB,                                                \
    (data, update_asset_info, data.update_asset_info), 117)
...
#define waves_Transaction_data_lease_cancel_MSGTYPE                            \
  waves_LeaseCancelTransactionData
#define waves_Transaction_data_create_alias_MSGTYPE                            \
  waves_CreateAliasTransactionData
#define waves_Transaction_data_mass_transfer_MSGTYPE                           \
  waves_MassTransferTransactionData
#define waves_Transaction_data_data_transaction_MSGTYPE                        \
  waves_DataTransactionData
#define waves_Transaction_data_set_script_MSGTYPE waves_SetScriptTransactionData
#define waves_Transaction_data_sponsor_fee_MSGTYPE                             \
  waves_SponsorFeeTransactionData
#define waves_Transaction_data_set_asset_script_MSGTYPE                        \
  waves_SetAssetScriptTransactionData
#define waves_Transaction_data_invoke_script_MSGTYPE                           \
  waves_InvokeScriptTransactionData
#define waves_Transaction_data_update_asset_info_MSGTYPE                       \
  waves_UpdateAssetInfoTransactionData

#define waves_GenesisTransactionData_FIELDLIST(X, a)                           \
  X(a, CALLBACK, SINGULAR, BYTES, recipient_address, 1)                        \
  X(a, STATIC, SINGULAR, INT64, amount, 2)
#define waves_GenesisTransactionData_CALLBACK pb_default_field_callback
#define waves_GenesisTransactionData_DEFAULT NULL

#define waves_PaymentTransactionData_FIELDLIST(X, a)                           \
  X(a, CALLBACK, SINGULAR, BYTES, recipient_address, 1)                        \
  X(a, STATIC, SINGULAR, INT64, amount, 2)
#define waves_PaymentTransactionData_CALLBACK pb_default_field_callback
...
#define waves_DataTransactionData_DataEntry_FIELDLIST(X, a)

#define waves_DataTransactionData_DataEntry_CALLBACK NULL
#define waves_DataTransactionData_DataEntry_DEFAULT NULL
...
#define waves_ExchangeTransactionData_FIELDLIST(X, a)                          \
  X(a, STATIC, SINGULAR, INT64, amount, 1)                                     \
  X(a, STATIC, SINGULAR, INT64, price, 2)                                      \
  X(a, STATIC, SINGULAR, INT64, buy_matcher_fee, 3)                            \
  X(a, STATIC, SINGULAR, INT64, sell_matcher_fee, 4)                           \
  X(a, CALLBACK, REPEATED, MESSAGE, orders, 5)
#define waves_ExchangeTransactionData_CALLBACK pb_default_field_callback
#define waves_ExchangeTransactionData_DEFAULT NULL
#define waves_ExchangeTransactionData_orders_MSGTYPE waves_Order
...
extern const pb_msgdesc_t waves_DataTransactionData_DataEntry_msg;
...
#define waves_CreateAliasTransactionData_fields                                \
  &waves_CreateAliasTransactionData_msg
#define waves_DataTransactionData_fields &waves_DataTransactionData_msg
#define waves_DataTransactionData_DataEntry_fields                             \
  &waves_DataTransactionData_DataEntry_msg
#define waves_MassTransferTransactionData_fields                               \
  &waves_MassTransferTransactionData_msg
#define waves_LeaseTransactionData_fields &waves_LeaseTransactionData_msg
#define waves_LeaseCancelTransactionData_fields                                \
  &waves_LeaseCancelTransactionData_msg
...
#define waves_SetAssetScriptTransactionData_fields                             \
  &waves_SetAssetScriptTransactionData_msg
#define waves_SetScriptTransactionData_fields                                  \
  &waves_SetScriptTransactionData_msg
#define waves_ExchangeTransactionData_fields &waves_ExchangeTransactionData_msg
#define waves_SponsorFeeTransactionData_fields                                 \
  &waves_SponsorFeeTransactionData_msg
#define waves_InvokeScriptTransactionData_fields                               \
  &waves_InvokeScriptTransactionData_msg
#define waves_UpdateAssetInfoTransactionData_fields                            \
  &waves_UpdateAssetInfoTransactionData_msg
...
#define waves_DataTransactionData_DataEntry_size 0
/* waves_MassTransferTransactionData_size depends on runtime parameters */
#define waves_LeaseTransactionData_size (17 + waves_Recipient_size)
